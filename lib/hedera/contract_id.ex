defmodule Hedera.ContractId do
  @moduledoc "A Hedera Smart Contract Service contract identifier `shard.realm.num`."
  ...
  @doc "Encode as a `ContractID` protobuf message (the `contractNum` variant)."
