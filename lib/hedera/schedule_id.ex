defmodule Hedera.ScheduleId do
  @moduledoc "A Hedera Schedule Service schedule identifier `shard.realm.num`."
  ...
  @doc "Encode as a Hedera `ScheduleID` protobuf message."
